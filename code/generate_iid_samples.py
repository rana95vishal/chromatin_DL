...
def main():
    ...
    onlyfiles = ['edge_list_of_chr3L_drosophila_ChIA_Drop_0.1_PASS.txt', ]
    ...
    for DNA in onlyfiles:
        ...
        p2df = f'/data/shared/vishal/NMF-DNA/Data/sampled/df_{network_name}_{num_MCMC}_MCMC_pivot'
        p2feature = f'/data/shared/vishal/NMF-DNA/Data/sampled/feature_{network_name}_{num_MCMC}_MCMC_pivot'
