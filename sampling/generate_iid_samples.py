...
def main():
    ...
    parser.add_argument('--data_dir', default = 'Data/DNA/', help='folder for data')
    parser.add_argument('--result_dir', default = '../processed_data/DNA/', help='folder for output results')
    ...
    onlyfiles = ['edge_list_of_chr3R_drosophila_ChIA_Drop_0.1_PASS.txt', ]
    # onlyfiles += ['edge_list_of_chr2L_drosophila_ChIA_Drop_0.1_PASS.txt',
    ...
    for DNA in onlyfiles:
        ...
        # p2df = f'/data/shared/jianhao/online_cvxNDL_data/updated_0905_data_with_node_id/df_{network_name}_{num_MCMC}'
        # p2feature = f'/data/shared/jianhao/online_cvxNDL_data/updated_0905_data_with_node_id/feature_{network_name}_{num_MCMC}'
        ...
        #p2df = f'../processed_data//DNA/df_{network_name}_{num_MCMC}_MCMC_pivot'
        #p2feature = f'../processed_data/DNA/feature_{network_name}_{num_MCMC}_MCMC_pivot'
        #reconstructor.gen_MCMC_sample_in_df(p2df, p2feature)
